    ...
    def next_msg(self) -> MsgBase | None:
        ...
        try:
            ...
            try:
                ...
                msg_code_raw = struct.unpack_from('>I', packet)[0]
                ...
                msg_obj = cls.unpack(packet[4:])
                logger.debug(f'Successfully parsed message: {cls.__name__} [{msg_code_raw}]')
                return msg_obj
            ...
            if 'total_packet_size' in locals() and len(self._buffer) >= total_packet_size:
