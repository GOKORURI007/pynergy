...
ECODE_TO_HID: dict[int, int] = {
    272: 0x01AA,  # ('BTN_LEFT', 'BTN_MOUSE')
    273: 0x02AA,  # BTN_RIGHT
    274: 0x03AA,  # BTN_MIDDLE
    275: 0x04AA,  # BTN_SIDE
    276: 0x05AA,  # BTN_EXTRA
    1: 0x29,  # KEY_ESC
    2: 0x1E,  # KEY_1
    3: 0x1F,  # KEY_2
    4: 0x20,  # KEY_3
...
def ecode_to_hid(code: int) -> int:
    return ECODE_TO_HID.get(code, 0x00)


def hid_to_ecode(hid_id: int) -> int:
    return HID_TO_ECODE.get(hid_id, 0x00)
